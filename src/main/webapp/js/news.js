    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function (index, value) {
                ...
                var trr = '<tr onclick="javascript:location.href=\'http://localhost:8080/news/comments/' + value.id+'\'">';
                ...
                $("#list").append(trr + '<td>' + value.title + '</td>' + msg + tch + crs + '<td><button type="submit" class="btn btn-default" ' + delClk + '>Delete</button></td><td><button type="submit" class="btn btn-default" ' + updClk + '>Update</button></td></tr>');
                //alert(value);
            });
        },
        error: function (data) {
