...
public class GenderBasedStatisticsService {
     ...
     */
    public Optional<GenderBasedStatisticsDto> findGraduatedStudentsByGender(Gender gender) {
        return studentService.findByGender(gender)
                .flatMap(studentDtos -> buildGenderBasedStatisticDto(studentDtos, gender));
    }

    private Optional<GenderBasedStatisticsDto> buildGenderBasedStatisticDto(List<StudentDto> studentList, Gender gender) {
